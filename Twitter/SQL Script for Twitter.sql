...
twitter_user_id int not null primary key auto_increment, 
user_twitter_name varchar(60) not null,
user_display_name varchar(60) not null,
user_password varchar(100) not null,
user_email_address varchar(60) not null, 
user_profile_photo varchar(100));

create table user_connection(
user_connection_id int not null primary key auto_increment, 
user_connection_twitter_id int not null,
user_connection_following varchar(60), 
user_connection_following_id int not null);

create table tweet(
tweet_id int not null primary key auto_increment, 
tweet_user_id int not null,
tweet_retweet_name varchar(60),
tweet_content varchar(200) not null,
tweet_create_date datetime not null);
...
insert into twitter_user(twitter_user_id, user_twitter_name,user_display_name,user_password,user_email_address,user_profile_photo)
values
('1','Kenji','Eric Baek', '$2a$04$eLVzbPXpkD8PBd8/kx8tt.TtmVxsknNDDgzL6CxitNihIb0EHmt9q','eric.baek@somewherehere.com',''),
('2','Lett','Jason Minnow','$2a$04$eLVzbPXpkD8PBd8/kx8tt.TtmVxsknNDDgzL6CxitNihIb0EHmt9q','jason.minnow@somewherehere.com',''),
('3','Candy','Clara Thomson','$2a$04$eLVzbPXpkD8PBd8/kx8tt.TtmVxsknNDDgzL6CxitNihIb0EHmt9q','clara.thomson@somewherehere.com',''),
('4','Soldier','Cloud Strife','$2a$04$eLVzbPXpkD8PBd8/kx8tt.TtmVxsknNDDgzL6CxitNihIb0EHmt9q','cloud.strife@somewherehere.com',''),
('5','Baron','Jim Red','$2a$04$eLVzbPXpkD8PBd8/kx8tt.TtmVxsknNDDgzL6CxitNihIb0EHmt9q','jim.red@somewherehere.com','');
...
insert into user_connection(user_connection_id,user_connection_twitter_id,user_connection_following, user_connection_following_id)values(4,'2','Kenji', '1');
